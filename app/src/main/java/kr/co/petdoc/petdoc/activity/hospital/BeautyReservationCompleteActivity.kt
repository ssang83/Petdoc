...
import kr.co.petdoc.petdoc.fragment.hospital.BeautyReservationCompleteFragment

/**
 * Petdoc
 * Class: BeautyReservationCompleteActivity
 * Created by kimjoonsung on 2020/06/19.
 *
 * Description :
 */
class BeautyReservationCompleteActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val transaction = fragmentManager.beginTransaction().apply {
            replace(R.id.fragment, BeautyReservationCompleteFragment().apply {
