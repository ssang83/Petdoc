...
/**
 * Petdoc
 * Class: PetdocTVFragment
 * Created by kimjoonsung on 2020/04/02.
 *
 * Description : 홈 펫닥TV 화면
 */
class PetdocTVFragment : BaseFragment() {

    private val LOGTAG = "PetdocTVFragment"
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_petdoc_tv, container, false)
    }
