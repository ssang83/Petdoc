...
/**
 * Petdoc
 * Class: PetGuideFragment
 * Created by kimjoonsung on 2020/04/02.
 *
 * Description : 홈 반려백과 화면
 */
class PetGuideFragment : BaseFragment() {

    private val LOGTAG = "PetGuideFragment"
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_pet_guide, container, false)
    }
