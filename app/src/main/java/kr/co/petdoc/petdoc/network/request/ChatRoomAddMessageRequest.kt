...
/**
 * Petdoc
 * Class: ChatRoomAddMessageRequest
 * Created by kimjoonsung on 2020/06/01.
 *
 * Description :
 */
class ChatRoomAddMessageRequest(apiService: ApiService, tag: String, id:Int, msg: String) :
    ...
    override fun execute() {
        ...
        call = apiService.postChatMessage(roomId, body)
