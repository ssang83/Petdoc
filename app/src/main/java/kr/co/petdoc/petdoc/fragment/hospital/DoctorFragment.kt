...
import kotlinx.android.synthetic.main.fragment_doctor_introduce.*
...
class DoctorFragment : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_doctor_introduce, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Logger.d("fromHome : $fromHome, centerId : $centerId")
        if (!fromHome) {
