package kr.co.petdoc.petdoc.weekcalendar;
...
import kr.co.petdoc.petdoc.weekcalendar.decorator.DayDecorator;
import kr.co.petdoc.petdoc.weekcalendar.decorator.DefaultDayDecorator;
import kr.co.petdoc.petdoc.weekcalendar.eventbus.BusProvider;
import kr.co.petdoc.petdoc.weekcalendar.eventbus.Event;
import kr.co.petdoc.petdoc.weekcalendar.listener.OnDateClickListener;
import kr.co.petdoc.petdoc.weekcalendar.listener.OnWeekChangeListener;
import kr.co.petdoc.petdoc.weekcalendar.view.WeekPager;
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            int todayDateTextColor = typedArray.getColor(R.styleable
                    .WeekCalendar_todaysDateTextColor, ContextCompat.getColor(getContext(), R.color.veryLightPinkSeven));
