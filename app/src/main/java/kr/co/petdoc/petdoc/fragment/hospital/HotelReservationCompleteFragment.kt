...
import kotlinx.android.synthetic.main.fragment_hotel_reservation_complete.*
...
/**
 * Petdoc
 * Class: HotelReservationCompleteFragment
 * Created by kimjoonsung on 2020/06/19.
 *
 * Description :
 */
class HotelReservationCompleteFragment : BaseFragment() {

    private val TAG = "BeautyReservationCompleteFragment"
    private val HOTEL_BOOKING_DETAIL_REQUEST = "$TAG.hotelBookingDetailRequest"
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_hotel_reservation_complete, container, false)
    }
    ...
    override fun onDestroyView() {
        super.onDestroyView()
        if (mApiClient.isRequestRunning(HOTEL_BOOKING_DETAIL_REQUEST)) {
            mApiClient.cancelRequest(HOTEL_BOOKING_DETAIL_REQUEST)
        }
    }
